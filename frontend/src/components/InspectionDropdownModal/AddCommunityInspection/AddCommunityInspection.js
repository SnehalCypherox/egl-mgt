...
const AddCommunityInspection = ({ currentStep }) => {
    ...
    function getInspectionModalData(steps) {
        switch (steps) {
            case 0:
                return (
                    <div className='inspection-community-model-1' style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        <FormControl
                            size='small'
            ...
            case 5:
                return (
                    <div className='inspection-community-model-6' style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            case 6:
                return (
                    <div className='inspection-community-model-7'>

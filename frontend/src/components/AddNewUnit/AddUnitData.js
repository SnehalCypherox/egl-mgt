    ...
    return (
        <>
            ...
            {/* <div className='unit-model-3' style={{margin: '0 auto'}}>
                ...
                <Grid container spacing={0}>
                    <Grid item xs={6}>
                        <Typography className="model-title" sx={{ color: '#0071BC', fontWeight: '600', fontSize: '14px', lineHeight: '21px', mb: '10px' }}>
                            Bedrooms
                        </Typography>
                        <GlobalStateProvider>
                            <Counter name="count1" />
                ...
                <Typography variant='h6' className=" model-title" sx={{ mt: '30px', mb: '20px' }}>
